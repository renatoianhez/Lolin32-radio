...
#include <SPI.h> // SPI
#include "AudioTools.h" // Audio do Bluetooth
...
String urlRadio[30];
String endTudo = "https://gist.githubusercontent.com/renatoianhez/60f44f543459fcd37f5173850cae90f0/raw";
int indice = 0;
...
void baixaDados(const String& urlDado, int maxTokens, String* tokens) {
  ...
  if (httpCode == HTTP_CODE_OK) {
    URLTudo = http.getString();
    Serial.println("Endereco da radio baixado com sucesso");
  }
  else {
